...
def main():
    ...
    parser.add_argument(
        "--step-log",
        type=str,
        default="train_log_requester_per_5000_steps.csv",
        help="Path to per-5000-step training log CSV.",
    )
    parser.add_argument(
        "--episode-log",
        type=str,
        default="train_log_requester_per_episode.csv",
    ...
    plot_step_loss_epsilon(df_step, out_dir / "requester_step_loss_epsilon.png")
    plot_step_reward(df_step, out_dir / "requester_step_reward.png")
    plot_episode_reward(df_ep, out_dir / "requester_episode_reward.png")
    plot_episode_loss(df_ep, out_dir / "requester_episode_loss.png")

    print("Saved plots:")
    print(out_dir / "requester_step_loss_epsilon.png")
    print(out_dir / "requester_step_reward.png")
    print(out_dir / "requester_episode_reward.png")
    print(out_dir / "requester_episode_loss.png")
